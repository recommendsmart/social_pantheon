...
class BaseFieldOverrideListBuilder extends ConfigEntityListBuilder {
   ...
   */
  public function __construct(EntityTypeInterface $entity_type, EntityManagerInterface $entity_manager, ModuleHandlerInterface $module_handler) {
  ...
  public static function createInstance(ContainerInterface $container, EntityTypeInterface $entity_type) {
    return new static($entity_type, $container->get('entity.manager'), $container->get('module_handler'));
  }
  ...
  public function load() {
    $base_fields = array_filter($this->entityManager->getBaseFieldDefinitions($this->targetEntityTypeId), function ($field_definition) {
  ...
  public function buildRow(EntityInterface $base_field_override) {
    ...
    $row = [
      ...
      'data' => [
        ...
        'status' => $base_field_override->isNew() ? $this->t('Default') : $this->t('Overriden'),
      ],
    ];
