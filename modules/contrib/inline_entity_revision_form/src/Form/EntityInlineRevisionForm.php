...
namespace Drupal\inline_entity_revision_form\Form;
...
use Drupal\inline_entity_revision_form\InlineRevisionFormInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Generic entity inline form handler.
 */
class EntityInlineRevisionForm implements InlineRevisionFormInterface {
  ...
  public function entityForm(array $entity_form, FormStateInterface $form_state) {
    ...
    $this->moduleHandler->alter('inline_entity_revision_form_entity', $entity_form, $form_state);
