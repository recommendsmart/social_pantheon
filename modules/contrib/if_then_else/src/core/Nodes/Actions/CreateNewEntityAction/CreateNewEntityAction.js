  ...
  constructor(emitter, key, onChange) {
    ...
    this.component = {
      ...
      methods: {
        ...
        entitySelected(value) {
          ...
          if (value !== undefined && value !== null && value !== '') { //check if an entity is selected
            ...
            let bundle_list = drupalSettings.if_then_else.nodes.create_new_entity_action.entity_info[entity_id]['bundles'];
      ...
      created() {
        ...
        if (drupalSettings.if_then_else.nodes.create_new_entity_action.entity_info) {
          var entities_list = drupalSettings.if_then_else.nodes.create_new_entity_action.entity_info;
          ...
          if (this.selected_entity != undefined && typeof this.selected_entity != 'undefined' && this.selected_entity !== '') {
            ...
            if (drupalSettings.if_then_else.nodes.create_new_entity_action.entity_info) {
              let bundle_list = drupalSettings.if_then_else.nodes.create_new_entity_action.entity_info[selected_entity]['bundles'];
              Object.keys(bundle_list).forEach(itemKey => {
                this.bundles.push({
                  label: bundle_list[itemKey].label,
                  value: bundle_list[itemKey].bundle_id
