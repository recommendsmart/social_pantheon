...
namespace Drupal\if_then_else\core\Nodes\Actions\PublishNodeAction;
...
/**
 * Publish action node class.
 */
class PublishNodeAction extends Action {
  ...
  public function registerNode(NodeSubscriptionEvent $event) {
    $event->nodes[static::getName()] = [
      'label' => $this->t('Publish Node'),
      'description' => $this->t('Publish Node'),
      'type' => 'action',
