  ...
  constructor(emitter, key) {
    ...
    <div class="fields-container">
      <div class="form-fields-selection" >
        ...
        <multiselect @wheel.native.stop="wheel" v-if="field_selection=='list'" v-model="value" :show-labels="false" tag-placeholder="Add this as new tag" placeholder="Select Fields" label="name" track-by="code" :options="options" :taggable="true" @input="updateSelected" @tag="addTag"></multiselect>
        <br>
        <div class="radio">
