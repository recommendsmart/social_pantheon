class FormSubmissionEventControl extends Rete.Control {
  ...
  constructor(emitter, key, readonly) {
    ...
    <div class="fields-container">
      ...
      methods: {
        ...
        entitySelected(value) {
          ...
          if (value !== null) { //check if an entity is selected
            ...
            let bundle_list = drupalSettings.if_then_else.nodes.form_submission_event.entity_info[entity_id]['bundles'];
      ...
      created() {
        ...
        if (drupalSettings.if_then_else.nodes.form_submission_event.entity_info) {
          var entities_list = drupalSettings.if_then_else.nodes.form_submission_event.entity_info;
          ...
          if (this.selected_entity != undefined && typeof this.selected_entity != 'undefined' && this.selected_entity !== '') {
            ...
            if (drupalSettings.if_then_else.nodes.form_submission_event.entity_info) {
              if (selected_entity !== 'other_form') {
                var bundle_list = drupalSettings.if_then_else.nodes.form_submission_event.entity_info[selected_entity]['bundles'];
                Object.keys(bundle_list).forEach(itemKey => {
                  this.bundles.push({
                    label: bundle_list[itemKey].label,
                    value: bundle_list[itemKey].bundle_id
