...
namespace Drupal\if_then_else\core\Nodes\Events\AfterSavingNewEntityEvent;
...
/**
 * After saving new entity event class.
 */
class AfterSavingNewEntityEvent extends Event {
  ...
  public static function getName() {
    return 'after_saving_new_entity_event';
  }

  /**
   * Event subscriber for after saving new entity event node.
   */
  public function registerNode(NodeSubscriptionEvent $event) {
    ...
    $event->nodes[static::getName()] = [
      'label' => $this->t('After Saving New Entity'),
      'description' => $this->t('After Saving New Entity'),
      'type' => 'event',
      'class' => 'Drupal\\if_then_else\\core\\Nodes\\Events\\AfterSavingNewEntityEvent\\AfterSavingNewEntityEvent',
      'library' => 'if_then_else/AfterSavingNewEntityEvent',
      'control_class_name' => 'AfterSavingNewEntityEventControl',
      'component_class_name' => 'AfterSavingNewEntityEventComponent',
