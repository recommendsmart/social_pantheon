...
class SystemTagForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['label'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Label'),
      '#description' => $this->t('Provide a label for the System Tag.'),
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($status === SAVED_NEW) {
      $this->messenger()->addMessage($this->t('Created new System Tag %label', [
        '%label' => $this->entity->label(),
      ]));
    }
    else {
      $this->messenger()->addMessage($this->t('Updated System Tag %label', [
        '%label' => $this->entity->label(),
      ]));
    }
