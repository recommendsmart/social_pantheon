(function ($) {
  ...
  SmartContentManager.condition_type['plugin:group'] = SmartContentManager.condition_type['plugin:group'] || {};
  SmartContentManager.condition_type['plugin:group'].ConditionGroup = {
  ...
  SmartContentManager.condition_type['plugin:broken'] = SmartContentManager.condition_type['plugin:broken'] || {};
  SmartContentManager.condition_type['plugin:broken'].ConditionBroken = {
    evaluate: function (values, context) {
      return context;
    }
  }
