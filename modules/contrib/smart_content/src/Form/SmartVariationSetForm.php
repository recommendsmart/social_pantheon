...
class SmartVariationSetForm extends EntityForm {
  ...
  /**
   * Utility for storing SmartVariationSet $entity based on parents.
   *
   ...
   * SmartVariationSet entities may exist.
   */
  ...
  /**
   * Retrieves SmartVariationSet $entity based on $parents.
   */
