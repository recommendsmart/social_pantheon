  ...
  const aggridGSJSON = {
    parserTypes: {
      ...
      per: {
        regEx: '^([1]([.]?[0]{1,4}?)?$|([.]\\d{1,4})$)',
        restrictInput: 'numeric',
        errorMsg: 'Value must be a positive decimal percentage value <= 1 (100%) and ten thousandths max (.####). (Example: .8945 for 89.45%) No % or other characters.'
      },
      perN: {
        regEx: '^-([1]([.]?[0]{1,4}?)?$|([.]\\d{1,4})$)',
        restrictInput: 'numeric',
        errorMsg: 'Value must be a negative decimal percentage value <= 1 (100%) or >= -1 (-100%) and ten thousandths max (.####). (Example: -.8945 for -89.45%) No % or other characters.'
      },
      perPN: {
        regEx: '^-?([1]([.]?[0]{1,4}?)?$|([.]\\d{1,4})$)',
        restrictInput: 'numeric',
        errorMsg: 'Value must be a positive/negative decimal percentage value <= 1 (100%) or >= -1 (-100%) and ten thousandths max (.####). (Example: .8945 for 89.45%) No % or other characters.'
      }
    },
    formatTypes: {
      numDec: {
