...
/**
 * List builder for the party entity.
 */
class PartyListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new PartyListBuilder object.
   *
  ...
  public function render() {
    ...
    $build['table']['#empty'] = $this->t('There are no parties available. Add one now.');
