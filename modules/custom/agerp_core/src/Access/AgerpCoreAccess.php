...
namespace Drupal\agerp_core\Access;
...
/**
 * Check access for agerp_core.
 */
class AGERPCoreAccess implements RoutingAccessInterface, ContainerInjectionInterface {
  ...
  /**
   * Checks access for AGERP Core overview.
   *
