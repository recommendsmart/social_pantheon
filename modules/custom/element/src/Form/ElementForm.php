...
class ElementForm extends ContentEntityForm {
  ...
  /**
   * Constructs a ElementForm object.
   *
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['publishing_status'] = [
      ...
      '#group' => 'advanced',
      '#weight' => 30,
      '#attached' => ['library' => ['element/form']],
      '#attributes' => [
        'class' => ['element-form-publishing-status'],
      ],
    ];
    ...
    $form['authoring_information'] = [
      ...
      '#attached' => ['library' => ['element/form']],
      '#attributes' => [
        'class' => ['element-form-authoring-information'],
      ],
    ];
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $message = $this->t('Created the %label element.', $replacements);
        break;

      default:
        $message = $this->t('Saved the %label element.', $replacements);
    }
    $this->messenger()->addMessage($message);

    $form_state->setRedirect('entity.element.collection');
  }
