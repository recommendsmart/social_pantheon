...
/**
 * Provides a form for reverting a element revision for a single translation.
 *
 * @ingroup element
 */
class ElementRevisionRevertTranslationForm extends ElementRevisionRevertForm {
  ...
  public function getFormId() {
    return 'element_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $element_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $element_revision);
  ...
  protected function prepareRevertedRevision(ElementInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\element\Entity\ElementInterface $latest_revision */
