 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/agerp/orders/type/{orders_type}",
 *     "add-form" = "/admin/agerp/orders/type/add",
 *     "edit-form" = "/admin/agerp/orders/type/{orders_type}/edit",
 *     "delete-form" = "/admin/agerp/orders/type/{orders_type}/delete",
 *     "collection" = "/admin/agerp/orders/type"
 *   }
 * )
 */
