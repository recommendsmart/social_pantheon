 ...
 *   config_prefix = "type",
 *   handlers = {
 *     "access" = "Drupal\crm_core_farm\RecordTypeAccessControlHandler",
 *     "form" = {
 *       "default" = "Drupal\crm_core_farm\Form\RecordTypeForm",
 *       "delete" = "Drupal\Core\Entity\EntityDeleteForm",
 *     },
 *     "list_builder" = "Drupal\crm_core_farm\FarmTypeListBuilder",
 *     "route_provider" = {
