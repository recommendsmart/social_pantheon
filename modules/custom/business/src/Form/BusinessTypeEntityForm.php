...
class BusinessTypeEntityForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\business\Entity\BusinessTypeEntityInterface $entity_type */
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\business\Entity\BusinessTypeEntity::load',
      ],
