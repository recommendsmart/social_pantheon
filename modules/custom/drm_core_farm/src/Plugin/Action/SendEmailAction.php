...
/**
 * Sends e-mail to farms.
 *
 * @Action(
 *   id = "send_email_action",
 *   label = @Translation("Send an e-mail to farms"),
 *   type = "drm_core_farm"
 * )
 */
class SendEmailAction extends ConfigurableActionBase implements ContainerFactoryPluginInterface {
  ...
  public function executeMultiple(array $objects) {
    ...
    foreach ($objects as $farm) {
      ...
      $email = $farm->getPrimaryEmail()->value;
      $params = array('subject' => $subject, 'message' => $message);
      $langcode = $this->languageManager->getCurrentLanguage()->getId();
      $this->mailManager->mail('drm_core_farm', 'send_email', $email, $langcode, $params);
    }
  }
