...
/**
 * Access control handler for DRM Core Business type entities.
 */
class BusinessTypeAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\drm_core_farm\Entity\BusinessType $entity */
    ...
    switch ($operation) {
      case 'delete':
        ...
        // delete it.
        $results = \Drupal::entityQuery('drm_core_business')
