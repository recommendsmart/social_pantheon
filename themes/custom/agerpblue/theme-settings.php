 ...
 */
function agerpblue_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  // If the default theme is either agerpblue or socialsaas then extend
  ...
  if (array_key_exists('socialbase', \Drupal::service('theme.manager')->getActiveTheme()->getBaseThemes())) {
    if ($active_theme == $system_theme_settings) {
      ...
      $form['#submit'][] = 'agerpblue_save_email_logo';
 ...
 */
function agerpblue_save_email_logo(array $form, FormStateInterface $form_state) {
